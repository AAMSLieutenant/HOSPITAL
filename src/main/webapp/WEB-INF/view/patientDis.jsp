    ...
    <div class="container">
        ...
        <div class="form-group col-xs-10">
            <div class="form-group">
                <h2>Информация о пациенте</h2><br />
                ...
                <input type="text" id="pBirthDate" class="form-control" value="${requestScope.patient.pBirthDateString}" readonly/><br>
                <label for="pArrivalDate">Дата поступления:</label>
                <input type="text" id="pArrivalDate" class="form-control" value="${requestScope.patient.pArrivalDateString}" readonly/><br>
                <div>АДРЕС</div>
                <br />
                            ...
                            <c:when test="${appointments==true}">
                                <table class="table table-striped" border="1">
                                    ...
                                    <tr align="center">
                                        ...
                                        <td ><c:out value="${appointment.appDateString}"/></td>
                                        ...
                                        <table class="table table-striped" border="1">
                                            ...
                                            <c:forEach var="operInfo" items="${requestScope.operInfosDb}">
                                                <tr align="center">
                                                    ...
                                                    <td ><c:out value="${operInfo.operDateString}"/></td>
                                        ...
                                        <table class="table table-striped" border="1">
                                            ...
                                            <c:forEach var="medInfo" items="${requestScope.medInfosDb}">
                                                <tr align="center">
                                                    ...
                                                    <td ><c:out value="${medInfo.medStartString}"/></td>
                                                    <td ><c:out value="${medInfo.medEndString}"/></td>
                                        ...
                                        <table class="table table-striped" border="1">
                                            ...
                                            <c:forEach var="procInfo" items="${requestScope.procInfosDb}">
                                                <tr align="center">
                                                    ...
                                                    <td ><c:out value="${procInfo.procDateString}"/></td>
